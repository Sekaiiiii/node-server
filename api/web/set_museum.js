...
router.post("/", function (req, res, next) {
    async.waterfall([
        ...
        function setMuseum(connect, done) {
            let sql = `
            update
                museum
            set
            ...
            let set_obj = {
                name: req.body.name,
                establishment_time: req.body.establishment_time,
                open_time: req.body.open_time,
                close_time: req.body.close_time,
                introduction: req.body.introduction,
                visit_info: req.body.visit_info,
                attention: req.body.attention,
                exhibition_score: req.body.exhibition_score,
                environment_score: req.body.environment_score,
        ...
        function setPosition(connect, done) {
            let sql = `
            update
                position
            set
            ...
            param_list.push(set_obj);
            param_list.push(req.body.position_id);
...
router.use("/", function (err, req, res, next) {
    switch (err.message) {
        ...
        case "204":
            ...
            break;
        case "205":
            res.send(return_obj.fail("205", "没有修改博物馆数据"));
            break;
        default:
